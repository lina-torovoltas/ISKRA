; Only works on linux!!!
; ISKRA-Burya32 ver1.0-compressed on FASM
...
segment readable writeable
    ...
    hex_buffer rb 9 ; Output buffer for 16 hex chars + newline
...
; Main hash loop: process each byte of data_bytes to update registers A and D
; - Add current byte to A modulo 16-bit
; - Mix bits of current byte: shift left by 3, shift right by 5, OR results
; - XOR result with D
; - Rotate D left by 1 bit (circular)
; - XOR rotated D with A
; - Swap A and D to mix the hash state
...
; Convert registers A and D to hex and store in hex_buffer
